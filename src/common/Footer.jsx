  ...
  return (
    <>
      <footer className="m-3 p-2">
        <div className="container mx-auto flex flex-wrap justify-between border-t border-b border-gray-200 py-6 mb-8">
          <form className="flex flex-wrap sm:flex-nowrap w-full sm:max-w-sm px-6" name="subscribe" method="POST">
            <input
              type="text"
              name="email"
              required=""
        ...
        <div className="container mx-auto px-6 flex flex-wrap uppercase text-sm font-bold text-gray-900 py-6">
          ...
          <div className="w-full mt-12 md:mt-0 md:w-4/12">
            <h4>FWRD ON THE GO</h4>
            <p className="normal-case leading-relaxed mt-2 max-w-sm">Receive 15% OFF your first in-app purchase. iPad App use code: FWRDIPAD15 Restrictions may apply.</p>
          </div>
        </div>
        <div className="container mx-auto text-center py-12 mt-12 border-t border-gray-200 text-xs uppercase">
          <div>Copyright © DeepaShri</div>
          <div className="text-gray-400 mt-2">github code</div>
        </div>
      </footer>
    </>
  );
